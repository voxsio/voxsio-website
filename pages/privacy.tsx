    ...
    return (
        <Layout>
            ...
            <div className={s.container}>
                <h3>Who are we?</h3>
                <p>
                Voxsio developed the <b>UB-OK</b> app to help young people manage their mental and physical health.
                </p>
                ...
                <p>
                    Voxsio collect and processes several different types of information:
                    <ol>
                ...
                <p className={s.indent}>IG Officer, Voxsio Ltd, Bayes Centre, 47 Potterrow, Edinburgh EH8 9BT, Scotland</p>
